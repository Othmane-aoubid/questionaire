<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
      ...
      <!-- Error State -->
      <div v-else-if="store.error" class="bg-red-50 border-l-4 border-red-400 p-4 mb-8">
        <div class="flex">
              ...
              <div class="flex flex-col space-y-4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-4 sm:space-y-0">
                  <input 
                    ...
                    @input="updateQuestion(section.id, question.id, { answer: question.answer })"
                    type="text"
                  ...
                  <div class="flex items-center space-x-2">
                    <button 
                      @click="updateQuestionStatus(section.id, question.id, 'good')"
                      :class="[
                    ...
                    <button 
                      @click="updateQuestionStatus(section.id, question.id, 'bad')"
                      :class="[
                        'p-2 rounded-full transition-all duration-300',
                        question.status === 'bad' 
    ...
    const updateQuestionStatus = async (sectionId, questionId, status) => {
      ...
      if (section) {
        ...
        if (question) {
          ...
          await store.updateQuestion(sectionId, questionId, { status: newStatus })
        }
      }
    }
